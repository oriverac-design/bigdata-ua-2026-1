...
| **CÓDIGO DEL ESTUDIANTE:** | 2221895512| **NÚMERO DE CLASE:** | Ciclo 8 - Sección 6 - 202601|
|---|---|---|---|
| **APELLIDOS Y NOMBRES:** | Giancarlos alegria ibarra| **FECHA ENTREGA:** |27/06/2026 |
| **DOCENTE:** | **Mg. Rubén Quispe Llacctarimay** | **Modalidad:** | **Implementación + Video** |

---

link de video:https://www.loom.com/share/7bfb4ed153014a76b8169507b340982c

link de git:https://github.com/giancarlosalegria39/Examen-Parcial-Giancarlos

link de arquitectura:https://drive.google.com/file/d/1jvcnVkYr3mUKQzUusfp_bAOsYfrkR4WJ/view?usp=sharing
...
Docker se utilizaría para que el equipo de desarrollo tenga un entorno local idéntico al de producción, permitiendo realizar pruebas, depuración y desarrollo sin depender de Internet ni afectar la base de datos en la nube.

b) ¿Qué ventaja tiene Atlas M0 sobre el contenedor Docker para el contexto universitario?

MongoDB Atlas M0 ofrece una base de datos administrada en la nube, accesible desde cualquier lugar, con respaldos automáticos y configuración mínima. Para un entorno universitario facilita el trabajo colaborativo sin instalar servidores locales.
...
Al ejecutar docker stop y posteriormente docker rm, el contenedor se elimina y, si no se utilizaron volúmenes persistentes, también se pierden los datos almacenados en él. En cambio, los datos de MongoDB Atlas permanecen almacenados en la nube y continúan disponibles aunque la aplicación se cierre.
